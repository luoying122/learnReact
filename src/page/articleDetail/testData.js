...
export const commentRes = {
  ...
  data: {
    ...
    data: [
      {
        reportnum: 0,
        commenttime: 1583115756000,
        creatorid: "e164f946e114405dbaae074ec18c1a52",
        reportStatus: 0,
        replyList: [],
        userId: null,
        content:
          "作为从本次比赛众多队伍中脱颖而出的冠军方案，评分达到0.845，从数据清洗、模型构建、目标优化等有非常多值得学习的地方。作者介绍了冠军方案中涉及到的各个子模型的用途以及具体的提分，包括如何提取特征、提取了什么特征以及提取特征的意义。但是尚未从特征角度阐述为什么要提取这些特征，以及如何通过数据EDA来辅助特征工程，但是依然构造出有意义的特征并最终提升模型的效果，有很多值得借鉴的地方！",
        upnum: 4,
        htmlContent:
          "<p>作为从本次比赛众多队伍中脱颖而出的冠军方案，评分达到0.845，从数据清洗、模型构建、目标优化等有非常多值得学习的地方。作者介绍了冠军方案中涉及到的各个子模型的用途以及具体的提分，包括如何提取特征、提取了什么特征以及提取特征的意义。但是尚未从特征角度阐述为什么要提取这些特征，以及如何通过数据EDA来辅助特征工程，但是依然构造出有意义的特征并最终提升模型的效果，有很多值得借鉴的地方！</p>\n",
        replyCount: 0,
        deleted: 0,
        ico:
          "https://file.turingtopia.com/imagepool/2019-03-15/1463199503929998593.png",
        nickname: "nianliu107",
        disid: "99c5925a9c834fc5bcee8943d6297342",
        upStatus: 0,
        cid: "b400540441d74074b3e8b212e70dfb80",
        direction: "恒河沙",
        username: "nianliu107",
      },
      {
        reportnum: 0,
        commenttime: 1582809202000,
        creatorid: "8e3a86a5af924f0eb97de2be08ee6f5b",
        reportStatus: 0,
        replyList: [
          {
            rid: "e17fef3f60dc48f4910ee353dcf76cfa",
            replytime: 1583504970000,
            cid: "36125629b9164a96b4b0dcc4ac1a665a",
            replyfrom: "c871df2cf3024d2b9275a1d58d828d5d",
            fromUsername: "markeloff",
            fromico:
              "https://file.turingtopia.com/imagepool/2019-11-20/1296085776552757422.jpg",
            fromDirection: "恒河沙",
            replyto: "4aefecfc7dbd4704a617a72455256303",
            toUsername: "lixiaomei",
            toico:
              "https://file.turingtopia.com/imagepool/2020-04-22/7121180030004477060.jpeg",
            toDirection: "通信",
            upnum: 0,
            reportnum: 0,
            deleted: 0,
            ...
            upStatus: 0,
            reportStatus: 0,
            fromNickname: "markeloff",
            toNickname: "lixiaomei",
          },
          {
            rid: "2d88aa0371b5468a947ea1a8ba7f3bfb",
            replytime: 1583504930000,
            cid: "36125629b9164a96b4b0dcc4ac1a665a",
            replyfrom: "c871df2cf3024d2b9275a1d58d828d5d",
            fromUsername: "markeloff",
            fromico:
              "https://file.turingtopia.com/imagepool/2019-11-20/1296085776552757422.jpg",
            fromDirection: "恒河沙",
            replyto: "15f766572c1f4bf7a36f1682b1cb240d",
            toUsername: "无能万金油",
            toico:
              "https://file.turingtopia.com/imagepool/2019-11-20/6134569161790436313.jpg",
            toDirection: "",
            upnum: 0,
            reportnum: 0,
            deleted: 0,
          ...
          {
            rid: "1c6e0f2ae37646d993808647e135598b",
            replytime: 1583476265000,
            cid: "36125629b9164a96b4b0dcc4ac1a665a",
            replyfrom: "15f766572c1f4bf7a36f1682b1cb240d",
            fromUsername: "无能万金油",
            fromico:
              "https://file.turingtopia.com/imagepool/2019-11-20/6134569161790436313.jpg",
            fromDirection: "恒河沙",
            replyto: "8e3a86a5af924f0eb97de2be08ee6f5b",
            toUsername: "ouc1602",
            toico:
              "https://file.turingtopia.com/imagepool/2019-12-02/5386903586591930522.jpg",
            toDirection: "医疗",
            upnum: 0,
            reportnum: 0,
            deleted: 0,
            content:
              "<p>发现代码里面有个attention的操作，不知道您测试的结果，这个时间维度上的attention对结果有帮助吗 或者说帮助大吗</p>",
            htmlContent:
              "<p>发现代码里面有个attention的操作，不知道您测试的结果，这个时间维度上的attention对结果有帮助吗 或者说帮助大吗</p>\n",
            upStatus: 0,
            reportStatus: 0,
        ...
        userId: null,
        content: "觉得好请点个赞呀，这对我们很重要",
        upnum: 4,
        htmlContent: "<p>觉得好请点个赞呀，这对我们很重要</p>\n",
        replyCount: 4,
        deleted: 0,
        ico:
          "https://file.turingtopia.com/imagepool/2019-12-02/5386903586591930522.jpg",
